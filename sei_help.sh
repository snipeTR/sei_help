...
echo -e "\e[0m\e[36mWithdraw rewards with commision:\t \e[0m\e[32mseid tx distribution withdraw-rewards \033[33;4m<ValidatorAddress>\e[0m\e[32m --from=\033[33;4m<wallet_name>\e[0m\e[32m --commission --chain-id=\033[33;4m<chain_id>\e[0m"
